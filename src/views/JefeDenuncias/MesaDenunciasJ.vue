<template>
    <div class="card shadow-sm p-4">
        <h1 style="text-align: center;">Procurador de Denuncias</h1>
        <br>
        <div class="row mb-3">
            <div class="col-md-3">
...
export default {
    ...
    watch: {
        campoFiltro(newCampo) {
            ...
            axios.get(`${Global.url}Jefe/valoresFiltro`, {
    ...
    methods: {
        ...
        async cargarDenuncias() {
            try {
                ...
                const response = await axios.get(`${Global.url}Jefe/listar`, {
                    headers: { Authorization: `Bearer ${token}` },
                    params
                });
        ...
        irAExpediente(idSicoda) {
            this.$router.push({ path: `/expedienteJ/${idSicoda}` });
        },
        // ...otros métodos
